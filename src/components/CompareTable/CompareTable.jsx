    ...
    return (
        <div className="container mx-auto border border-white">
            <table className="min-w-full shadow-md rounded-lg border-collapse">
                <thead>
                    <tr>
                        <th className="py-3 px-6 bg-yellow-500 text-left text-sm font-bold uppercase tracking-wider">Differences</th>
                        <th className="py-3 px-6 bg-yellow-500 text-left text-sm font-bold uppercase tracking-wider">{coin1Data?.name}</th>
                        <th className="py-3 px-6 bg-yellow-500 text-left text-sm font-bold uppercase tracking-wider">{coin2Data?.name}</th>
                    </tr>
                </thead>
                {coin1Data && coin2Data ? <tbody>
                    ...
                    <CompareTableRow type="percentage" data1={coin1Data?.market_data?.price_change_percentage_7d} data2={coin2Data?.market_data?.price_change_percentage_7d} diff={"7d Price Change"} />
